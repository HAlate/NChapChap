-- Migration PARTIE 2: Mettre à jour la fonction create_new_trip
-- Date: 2026-01-23
-- Description: Deuxième étape - Modification de la fonction pour accepter 'any'

-- Mettre à jour la fonction create_new_trip pour accepter 'any' comme valeur par défaut
...
DO $$
BEGIN
  RAISE NOTICE '✅ Migration terminée: vehicle_type supporte maintenant "any"';
  RAISE NOTICE '✅ Fonction create_new_trip mise à jour avec succès';
END $$;
