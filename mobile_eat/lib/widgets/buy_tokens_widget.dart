...
class _BuyTokensWidgetState extends ConsumerState<BuyTokensWidget> {
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _PaymentMethodOption(
              title: 'NJIA Token',
              subtitle: 'Payer avec crypto (Polygon)',
              icon: Icons.currency_bitcoin,
              color: Colors.purple,
              onTap: () => Navigator.pop(context, 'njia'),
            ),
          ],
        ),
      ),
  ...
  /// Ouvre le modal de paiement NJIA Token
  Future<void> _openNjiaModal(TokenPackage package) async {
    // TODO: Implémenter le modal NJIA Token
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Paiement NJIA Token - En cours de développement'),
