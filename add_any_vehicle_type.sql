-- Migration: Ajouter 'any' au type vehicle_type pour accepter tous les véhicules
-- Date: 2026-01-23
-- Description: Permet aux riders de s'adresser à tous les types de véhicules

-- =====================================================
-- PARTIE 1: Ajouter 'any' au type ENUM vehicle_type
-- =====================================================
-- NOTE: Cette commande doit être exécutée SEULE en premier
-- puis attendre quelques secondes avant d'exécuter la Partie 2
ALTER TYPE vehicle_type ADD VALUE IF NOT EXISTS 'any';

-- ⏸️ IMPORTANT: Après l'exécution de cette commande,
-- attendez quelques secondes, puis exécutez la Partie 2 ci-dessous

-- =====================================================
-- PARTIE 2: Mettre à jour la fonction create_new_trip
-- =====================================================
-- Exécuter cette partie APRÈS avoir ajouté 'any' à l'ENUM
...
-- Vérification
SELECT 'Migration terminée: vehicle_type supporte maintenant "any"' AS status;
