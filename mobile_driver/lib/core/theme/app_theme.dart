...
class AppTheme {
  ...
  static const Color primaryOrange = Color(0xFFE65100); // Material Orange 800
  ...
  static const Color earningsGold = Color(0xFFFFB300);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    switchTheme: SwitchThemeData(
      ...
      trackColor: MaterialStateProperty.resolveWith((states) {
        if (states.contains(MaterialState.selected)) {
          return statusOnline.withOpacity(0.5);
        }
        return statusOffline.withOpacity(0.5);
      }),
    ),
