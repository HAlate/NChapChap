class TokenPackage {
  ...
  factory TokenPackage.fromJson(Map<String, dynamic> json) {
    return TokenPackage(
      ...
      tokenType: json['token_type'] as String? ?? 'course',
      tokenAmount: json['token_amount'] as int,
      priceXof: json['price_F CFA'] as int? ?? json['price_xof'] as int? ?? 0,
      priceGhs: json['price_ghs'] as int?,
      priceNgn: json['price_ngn'] as int?,
      priceXaf: json['price_xaf'] as int?,
      discountPercent:
          json['bonus_tokens'] as int? ?? json['discount_percent'] as int? ?? 0,
